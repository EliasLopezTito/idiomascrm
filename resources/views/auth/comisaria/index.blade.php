...
@section('content')
    ...
    <div class="container-fluid">
        <form>
        <input type="hidden" id="reserenazgos" value="{{ count($Comisarias) }}">
        <div class="row">
            <div class="col-sm-12">
                <div class="row mt-15">
                    <div class="col-sm-2">
        ...
        <div class="mt-15">
            <div class="col-sm-12 p-0">
                <button id="btnAgregarComisaria" type="button" class="btn btn-warning pull-right mb-15"> <i class="fa fa-plus"></i></button>
            </div>
            <div class="col-sm-12 table-responsive p-0">
                <table id="tablaComisaria" class="table table-striped table-bordered table-hover dataTable no-footer">
                    <thead>
                    <tr>
                        <th>DELITO</th>
                        <th>ENE</th>
...
@section('scripts')
    ...
    {{ Html::script('/auth/views/comisaria/index.js') }}
    {{ Html::script('/auth/views/comisaria/indexMaintenance.js') }}
@endsection
