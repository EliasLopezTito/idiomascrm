...
@section('content')
    <section class="content-header">
        <h1> Incidencia Relevante <small> Mantenimiento </small></h1>
    </section>
                    ...
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-12">
                                ...
                                <div class="col-sm-2">
                                    <div class="mt-25">
                                        <button type="submit" class="btn btn-success col-sm-12 " id="btnNewIncidenciaRelevante">
                            ...
                            <div class="col-sm-12">
                                <div class="mt-15">
                                    <div class="col-sm-12 col-md-6 p-0">
                                        <p class="text-uppercase title">LISTADO DEL PERSONAL</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 mt-5">
                                <table id="tableIncidenciaRelevante" class="table table-striped table-bordered table-hover"></table>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    {{ Html::script('https://maps.googleapis.com/maps/api/js?key=AIzaSyA-DTKUVySzRIiExw84SXi8Jrdl3-9VNVM')  }}

    {{ Html::script('/auth/views/incidenciaRelevante/index.js')  }}
