            ...
            <table class="letra" width="100%" border="0" align="center" cellpadding="8" cellspacing="0" bordercolor="#dddddd" id="bmail">
                ...
                <tr style="color:#696868;">
                    <td>
                        ...
                        <p class="letra">Nos complace comunicarle que a través de nuestro sitio web tienda en linea
                            <a href="http://cakestore-upc.sptstudio.com/" style="color: #b91e1e;text-decoration: underline;cursor: pointer;font-weight: bold;">CakeStore</a>, su contraseña
                            ha sido modificada con el siguiente valor :</p>
                    </td>
                </tr>
                 ...
                 <td>
                     <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0" id="data"
                         ...
                         <tbody>
                         <tr class="letra">
                             <th width="41%" align="right" style="background:#eeeeee;color:#000">Nueva contraseña :</th>
                 ...
                 <tr>
                 <td>
                    <p class="letra" style="color:#696868;">Recuerde que este portal le informará sobre los servicios de compra o modificaciones personales que vaya realizando.
                     Además contará con un historial de sus pedidos e información necesaria para que evite todos los inconvenientes que pueda presentar.</p>
                    <p class="letra"  style="color:#696868;">Así mismo, invitarlo cordialmente a navegar en las distintas páginas de información sobre nuestra tienda y descubrir su amigable funcionalidad.</p>
