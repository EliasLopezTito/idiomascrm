...
@section('content')
    <section class="content-header">
        <h1> Categorías <small> Mantenimiento </small></h1>
    </section>
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <a href="{{ route('auth.categorie.view', ['id' => 0 ]) }}"class="btn btn-primary pull-right" id="btnNewCategorie">
                            <span class="fa fa-plus"></span>  Nueva Categoría
                        </a>
                    </div>
                    <div class="box-body">
                        <table id="tableCategorie" class="table table-striped table-bordered table-hover"></table>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    {{ Html::script('/auth/views/categorie/index.js')  }}
