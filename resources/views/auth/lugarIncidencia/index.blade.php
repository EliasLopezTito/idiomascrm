...
@section('content')
    <section class="content-header">
        <h1> Lugar Incidencia <small> Mantenimiento </small></h1>
    </section>
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <button type="button" class="btn btn-primary pull-right" id="btnNewLugarIncidencia">
                            <span class="fa fa-plus"></span>  Nuevo Lugar de Incidencia
                        </button>
                    </div>
                    <div class="box-body">
                        <table id="tableLugarIncidencia" class="table table-striped table-bordered table-hover"></table>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    {{ Html::script('/auth/views/lugarIncidencia/index.js')  }}
