            ...
            <table class="letra" width="100%" border="0" align="center" cellpadding="8" cellspacing="0" bordercolor="#dddddd" id="bmail">
                ...
                <tr style="color:#696868;">
                    <td>
                        ...
                        <p class="letra">A continuacion le mostramos los datos necesarios a realizarse, para finalizar con su pedido.</p>
                        ...
                        <p class="letra">Puede ver el seguimiento de sus pedidos
                            <a href="https://comprando.pe/client/shopping" style="color: #b91e1e;text-decoration: underline;cursor: pointer;font-weight: bold;">aquí</a></p>
