    ...
    <div class="container-fluid">
        ...
        <div class="row mt-15">
            <div class="col-sm-12 text-center">
                <div class="mb-15">
                    <h3><b>Incidencia Relevantes Delicitivas Por Sectores</b></h3>
                </div>
...
@section('scripts')
    ...
    {{ Html::script('/auth/views/reporte/incidenciaRelevantesFiltroSectores.js') }}
@endsection
