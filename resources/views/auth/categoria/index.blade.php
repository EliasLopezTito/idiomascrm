            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <button type="button" class="btn btn-primary pull-right" id="btnNewCategoria">
                            <span class="fa fa-plus"></span>  Nueva Categoria
                        </button>
                    </div>
                    <div class="box-body">
                        <table id="tableCategoria" class="table table-striped table-bordered table-hover"></table>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    {{ Html::script('/auth/views/categoria/index.js')  }}
