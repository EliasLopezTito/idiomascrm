        ...
        <td>
            ...
            <table class="letra" width="100%" border="0" align="center" cellpadding="8" cellspacing="0" bordercolor="#dddddd" id="bmail">
                ...
                <tr style="color:#696868;">
                    <td>
                        <p class="letra">Hola, {{ Auth::guard('client')->user()->name. " ".Auth::guard('client')->user()->last_name }}. </p>
                        <p class="letra"> Su pedido <b> N° {{ $code }} </b> ha sido procesado. </p>

                        <p style="text-align: center;margin: 0 auto;widows: 100%;">
                            <img src="http://sptstudio.com/cakestore/order/2.jpg" alt="" />
                        </p>

                        <br>

                        <p class="letra">Ya estamos preparando tu pedido, en cuanto este listo te estaremos avisando por
                            mail.</p>

                        <p class="letra">Recuerde que la preparación de los pedidos pueden demorar hasta 72 horas
                        hábiles. Los pedidos se procesan de Lunes a Viernes de 9 a 18 horas.</p>
